...
class AddSingleRide extends StatefulWidget {
  const AddSingleRide({Key? key}) : super(key: key);


  @override
  State<AddSingleRide> createState() => _AddSingleRideState();
}

class _AddSingleRideState extends State<AddSingleRide> {
              ...
              child: Column(
                children: [
                  ...
                  const Center(
                    child: CircleAvatar(
                      radius: 90,
                      backgroundImage: NetworkImage("https://img.freepik.com/free-vector/front-car-concept-illustration_114360-7978.jpg?w=1060&t=st=1674936734~exp=1674937334~hmac=8d6ee6294388967c4ad740d6fe727af6ca5a844135397eaaf2952320432ce83b"),
