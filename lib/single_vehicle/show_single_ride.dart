...
class ShowSingleRide extends StatefulWidget {
  const ShowSingleRide({Key? key}) : super(key: key);

  @override
  State<ShowSingleRide> createState() => _ShowSingleRideState();
}

class _ShowSingleRideState extends State<ShowSingleRide> {
        ...
        child: Container(
          ...
          child: Column(
            children: [
              const CircleAvatar(
                radius: 60,
                backgroundImage: NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvwOvDfUQhmANcwC92OhdFUNzT9ElrO_jj7tMSNB9Lcw&s"),
              ),
              // SizedBox(
              //   width: 0.0468 * width,
              // ),
              ...
              const Text("                      At: 29 Jan                      ", style: TextStyle(fontSize: 15)),
              const Text("                      Price: 6900                      ", style: TextStyle(fontSize: 15, color: Colors.green)),
